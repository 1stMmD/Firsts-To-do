...
const todoElements = document.getElementsByClassName("todo-elements")
...
const noteElementsContainer = document.getElementById("noteElementsContainer");
...
function setUpNoteApp(){
    ...
    const noteAdd = document.getElementById("noteAdd");
    const noteEditor = document.getElementById("noteEditor");
    const noteEditorDescription = document.getElementById("noteEditorDescription");
...
function setUpNoteEvents(){
    let noteBodys = document.getElementsByClassName("note-body");
    let noteDeleteButtons = document.getElementsByClassName("note-delete-btn");
    let noteEditButtons = document.getElementsByClassName("note-edit-btn");
    let noteEditorDescription = document.getElementById("noteEditorDescription");
    let noteEditorTitle = document.getElementById("noteEditorTitle");
    ...
    for(let i = 0;i < noteBodys.length ;i++){
        ...
        noteEditButtons[i].onclick = (e) =>{
            isUpdate = true;
            let id = e.target.id;
            noteEditorDescription.value = allNotes[e.target.id].description;
            noteEditorTitle.value = allNotes[e.target.id].title;
            noteEditor.style.right = "0px";
            let noteEditorDone = document.getElementById("noteEditorDone");
            
            updateId = e.target.id;
                
        };

        noteDeleteButtons[i].onclick = (e) =>{
